...
function AssignmentEditor() {
  ...
  return (
    <div className="container">
      ...
      <div className="mb-3">
            <br/>
            <textarea className="form-control" id="exampleFormControlTextarea1" rows="4">{assignment.description}
            </textarea>
          </div>
          <div className="row">
            <div className="col-3"> 
            ...
            <div className="col-6">
            <div className="mb-3">
                <input type="number" className="form-control" id="exampleFormControlInput1" placeholder="Enter Points" value={assignment.points}/>
            </div>
            </div>
        </div>
        <div className="row">
        ...
        <div className="row">
            ...
            <div className="col-6">
                ...
                <div className="mb-3">
                    ...
                    <input type="date" class="form-control" id="exampleFormControlInput1" placeholder="Enter Due Date" value={assignment.due}/>
                  </div>
                  <div className="row">
                <div className="col">
                  <div className="mb-3">
